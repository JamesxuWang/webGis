define(
    [
        ...
        'js/modules/poltDraw/PlotFactory.js',
        'js/modules/poltDraw/ext/cs.js',
        'js/modules/poltDraw/ext/ct.js'
    ],
            ...
            activate:function(geometryType, options){
                ...
                if(this.extGeometryType.indexOf(geometryType)>=0){
                    ...
                    this.tipMoveHandle=on(this.map, "mouse-move", lang.hitch(this, function (evt) {
                        this.tipDiv.style.left=(evt.screenPoint.x+0)+"px";
                        this.tipDiv.style.top=(evt.screenPoint.y+100)+"px";
